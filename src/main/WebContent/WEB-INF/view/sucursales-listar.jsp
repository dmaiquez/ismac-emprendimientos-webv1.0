	...
	<section class="py-5 px-5">
		<div class="container">	
				...
				<div class="container" style="text-align: center">
					<button class="btn btn-primary" onclick="window.location.href='/ismac-emprendimientos-webv1.0/sucursales/findOne?opcion=1';return false;">
				...
				<table 	id="tabla1" 
					...
					<thead>
							...
							<!-- <th data-field="N°" data-sortable="true">idSucursales</th> -->
						...
						<tr>																								
							...
							<td>						
								<div class="container-fluid btn-group" role="group">
									<button class="btn btn-success" onclick="window.location.href='/ismac-emprendimientos-webv1.0/sucursales/findOne?idSucursales=${item.idSucursales}&opcion=1'; return false;">
									 <i class="fa-solid fa-arrows-rotate"></i> <!-- <p> Actualizar </p> --></button>
									<button class="btn btn-danger" onclick="window.location.href='/ismac-emprendimientos-webv1.0/sucursales/findOne?idSucursales=${item.idSucursales}&opcion=2'; return false;"> 
