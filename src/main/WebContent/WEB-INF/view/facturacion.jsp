...
<h1>Facturacion</h1>
	...
	<form action="addDetalle" id="formDetalles" name="formDetalles"  method="post">
		...
		<input type="text" id="numPedido" name="numPedido" value="${pedido.numPedido}" disabled />								
		confirmacion
		<input type="text" id="confirmacionPedido" name="confirmacionPedido" value="${pedido.confirmacionPedido}" disabled />	
		
		<h3>Forma Pago </h3>	
		formaPago
		<input type="hidden" id="idFormaPago" name="idFormaPago" value="${formapago.idFormaPago}" />
		<input type="text" id="formaspago" name="formaspago" value="${formapago.formaspago}" disabled />								
		confirmacion
		<input type="text" id=descripcion name="descripcion" value="${formapago.descripcion}" disabled />		
